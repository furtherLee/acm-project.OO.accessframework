package org.acm_project.acm09.OO.epcis.accessframework.japi.queryBroker;
...
import org.acm_project.acm09.OO.epcis.accessframework.japi.QueryControlInterface;
import org.acm_project.acm09.OO.epcis.accessframework.soap.DuplicateSubscriptionExceptionResponse;
import org.acm_project.acm09.OO.epcis.accessframework.soap.EPCISServicePortType;
...
public class QueryBroker extends Broker implements QueryControlInterface, TrustManager {
     ...
     *            </table>
     */
    public QueryBroker(String url, Object[] authenticationOptions) {
        if (url != null) {
            this.queryUrl = url;
        } else {
        ...
        if (is != null) {
            try {
                ...
                System.out.println("Unable to load queryclient properties from "
                        + QueryBroker.class.getResource(PROPERTY_FILE).toString() + ". Using defaults.");
            }
        } else {
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#getQueryNames()
     */
    public List<String> getQueryNames() throws ImplementationExceptionResponse, SecurityExceptionResponse,
            ValidationExceptionResponse {
        if (!serviceConfigured) {
            throw new QueryBrokerNotConfiguredException(
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#getStandardVersion()
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#getSubscriptionIds(java.lang.String)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#getVendorVersion()
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#poll(org.fosstrak.epcis.model.Poll)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#subscribe(org.fosstrak.epcis.model.Subscribe)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.fosstrak.epcis.QueryBrokerInterface.QueryControlInterface#unsubscribe(java.lang.String)
     */
